...
# MONKEY_60711 was generated by downloading ALL mappings (ftp://ftp.uniprot.org/pub/databases/uniprot/current_release/knowledgebase/idmapping/idmapping.dat.gz) and filtering for 'ENSCSAP'
PROTEIN_ID_MAPPING_FILE = os.path.join(DATADIR, {'hg19': 'HUMAN_9606', 'hg38': 'HUMAN_9606', 'mm10': 'MOUSE_10090', 'cs1.1': 'MONKEY_60711'}[GENOME] + '_idmapping.dat')  # file not exists. fine..
